...
def generate_account():
    ...
    address = "0x82E0CC59153F0326391fB252679f297856FacD17"
...
# Assuming 'person' is the selected candidate from the drop-down menu
hourly_rate = candidate_database[person][3]
...
st.sidebar.write(f"Worker's Wage: {wage} ETH")
...
if st.sidebar.button("Send Transaction"):
    ...
    transaction_hash = send_transaction(w3,account, candidate_address, w3.toWei(wage, "ether"))
